...
/* harmony import */ var _signIn_sign_in_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./signIn/sign-in.component */ "./src/app/signIn/sign-in.component.ts");
...
let AppComponent = class AppComponent {
    constructor(breakpointObserver, dialog) {
        ...
        this.photoIndex = 0;
        this.photos = [
            '../assets/header-background-puzzle.webp',
            '../assets/header-background-blue.png',
        ];
    ...
    ngOnInit() {
        this.photosIndexInterval = setInterval(() => {
            this.photoIndex++;
        }, 20000);
        // this.showSideMenu = this.breakpointObserver.isMatched('(max-width: 960px)');
    ...
    openSignInDialog() {
        const dialogRef = this.dialog.open(_signIn_sign_in_component__WEBPACK_IMPORTED_MODULE_5__["DialogSignInComponent"], {
            width: '350px'
        });
        ...
        animations: [
            Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["trigger"])('enterAnimation', [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["transition"])(':enter', [
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["style"])({ width: '0px' }),
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["animate"])('200ms', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["style"])({ width: '250px' }))
                ]),
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["transition"])(':leave', [
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["style"])({ width: '250px' }),
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["animate"])('200ms', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["style"])({ width: '0px' }))
                ])
            ])
        ],
...
/* harmony import */ var _signIn_sign_in_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./signIn/sign-in.component */ "./src/app/signIn/sign-in.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _signIn_sign_in_component__WEBPACK_IMPORTED_MODULE_7__["DialogSignInComponent"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSignInComponent", function() { return DialogSignInComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let DialogSignInComponent = class DialogSignInComponent {
    ...
    login(f) {
        console.log(f);
        if (f.valid) {
            let loginObject = f.value;
            console.log(loginObject);
        }
    }
};
DialogSignInComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] }
];
DialogSignInComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./sign-in.component.css */ "./src/app/signIn/sign-in.component.css")).default]
    })
...
module.exports = __webpack_require__(/*! E:\Shabikny\shabikny\src\main.ts */"./src/main.ts");
